            ...
            AnimationTracks =
            {
                new AnimationTrackComponentProperty
                {
                    ...
                    KeyFrames =
                    {
                        ...
                        new AnimationTrackProperty.KeyFrame(sprite.Color, (float) holdTime.TotalSeconds),
                        new AnimationTrackProperty.KeyFrame(sprite.Color.WithAlpha(0f), (float) fadeTime.TotalSeconds, Easings.OutSine),
                    },
                },
            },
        };

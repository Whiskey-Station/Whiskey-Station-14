...
public sealed partial class VocalSystem : EntitySystem
{
    ...
    private void OnEmote(Entity<VocalComponent> ent, ref EmoteEvent args)
    {
        ...
        RaiseLocalEvent(ent, ref getSoundEv);
        if (getSoundEv.Handled)
        {
            ...
            {
                args.Handled = _chat.TryPlayEmoteSound(ent.Owner, evSounds, args.Emote);
                return;
            }
        }
        // </Trauma>
    ...
    private bool TryPlayScreamSound(Entity<VocalComponent> ent, EntityUid user)
    {
        ...
        {
            return _chat.TryPlayEmoteSound(ent.Owner, evSounds, ent.Comp.ScreamId);
        }
        // </Trauma>

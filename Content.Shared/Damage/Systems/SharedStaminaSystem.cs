...
public abstract partial class SharedStaminaSystem : EntitySystem
{
        ...
        EntityUid? source = null) // Trauma
    {
        ...
        TakeStaminaDamage(target, component.Damage, stamina, source: source ?? uid, sound: component.Sound); // Trauma - try pass actual source
        TakeOvertimeStaminaDamage(target, component.Overtime); // Trauma
    }

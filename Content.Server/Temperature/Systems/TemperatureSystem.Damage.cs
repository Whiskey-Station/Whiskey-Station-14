...
public sealed partial class TemperatureSystem
{
    ...
    private void ChangeDamage(Entity<TemperatureDamageComponent> entity, TimeSpan deltaTime)
    {
        ...
        if (temperature.Temperature >= heatDamageThreshold && CanTakeHeatDamage(entity)) // Trauma - add heat damage check
        {
    ...
    private void ServerAlert(Entity<AlertsComponent> entity, ref TemperatureChangedEvent args)
    {
        ...
        {
            // <Goob> - don't show irrelevant alerts
        ...
        {
            // <Goob> - don't show irrelevant alerts
            if (!thresholds.HeatDamage.AnyPositive())
                return;
            // </Goob>

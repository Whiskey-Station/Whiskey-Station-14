...
{
    public override string StylesheetName => "SpyUplink";

    public override NotoFontFamilyStack BaseFont { get; } // TODO: NotoFontFamilyStack is temporary

    public static readonly ResPath TextureRoot = new("/Textures/_Trauma/Interface/SpyUplink");
    ...
    public SpyUplinkStylesheet(object config, StylesheetManager man) : base(config)
    {
        ...
        var rules = new[]
        {
            ...
            GetAllSheetletRules<SpyUplinkStylesheet, CommonSheetletAttribute>(man),
        };

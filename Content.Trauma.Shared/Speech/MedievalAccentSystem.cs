...
public sealed partial class MedievalAccentSystem : EntitySystem
{
    ...
    private static readonly ProtoId<SimpleAccentPrototype> Accent = "Medieval";

    [SubscribeLocalEvent]
    private void OnAccentGet(Entity<MedievalAccentComponent> ent, ref AccentGetEvent args)
    {
